    ...
    render() {
        return (
            <div style={{fontSize: 14}}>
                ...
                <p style={{"text-align": "justify", "line-height" : "1.8em"}}><span style={{"color": "#025695"}}><strong>The 9th International Conference on Internet
                ...
                <p style={{"text-align": "justify", "line-height" : "1.8em"}}>All previous ICIMCS papers have been indexed by EI. Selected high-quality
                    papers will be recommended to the special issue of the SCI-indexed multimedia journal this year.</p>
                <p style={{"text-align": "justify", "line-height" : "1.8em"}}>A "<span style={{"color" : "#FF0000"}}><strong>Best Paper Award</strong></span>" and a "<span
